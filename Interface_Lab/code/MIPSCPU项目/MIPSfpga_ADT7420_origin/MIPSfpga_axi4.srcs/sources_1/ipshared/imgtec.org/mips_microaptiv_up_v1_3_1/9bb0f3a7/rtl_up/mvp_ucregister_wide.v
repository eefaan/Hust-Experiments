//
//	Description: mvp_ucregister_wide
...
//
//	$Id: \$
//	mips_repository_id: mvp_ucregister_wide.v, v 3.2 
//
...
input  [WIDTH-1:0] d;
	...
	`M14K_UCREGW_MODULE #(WIDTH) cregister(q, scanenable, cond, clk, d);
