...
//
//	Description: m14k_gf_mux2 
//           Glitch free mux
//	      
//
//	$Id: \$
//	mips_repository_id: m14k_gf_mux2.mv, v 1.1 
//
...
// This mux needs only to ensure, that the unselected input can not cause
...
// NAND2X2 btermi (.y(bterm), .a(s), .b(b));	
	...
	assign y = !(aterm && bterm);
// NAND2X2 yi (.y(y), .a(aterm), .b(bterm));	
