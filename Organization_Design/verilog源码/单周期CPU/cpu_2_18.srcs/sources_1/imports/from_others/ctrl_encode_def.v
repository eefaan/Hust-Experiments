...
`define ALUOp_ADDU  5'b00101
`define ALUOp_ADD   5'b00101
`define ALUOp_SUBU  5'b00110
`define ALUOp_SUB   5'b00110
`define ALUOp_AND   5'b00111
`define ALUOp_OR    5'b01000
`define ALUOp_NOR   5'b01010
`define ALUOp_XOR   5'b01000
`define ALUOp_SLT   5'b01011
`define ALUOp_SLTU  5'b01100
...
`define ALUOp_SLL   5'b00000
`define ALUOp_SRL   5'b00010
`define ALUOp_SRA   5'b00001
