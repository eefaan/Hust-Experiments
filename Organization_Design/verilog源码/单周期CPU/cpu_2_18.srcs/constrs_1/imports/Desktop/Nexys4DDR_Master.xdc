...
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports {f_sw}]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
...
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { watch_addr[0] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { watch_addr[1] }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { watch_addr[2] }]; #IO_L24P_T3_35 Sch=sw[12]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { watch_addr[3] }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { display_code[0] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { display_code[1] }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
